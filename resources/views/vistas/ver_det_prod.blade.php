...
<div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
    ...
    <div class="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
      <img class="w-full" src="{{ $det[0]->binario_producto }}" alt="" />
    </div>
    <div class="md:hidden">
    ...
    <div class="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
      <div class="border-b border-gray-200 pb-6">
        <p class="text-sm leading-none text-gray-600 dark:text-gray-300 ">{{ $det[0]->titulo_empresa }}</p>
        <h1 class="lg:text-2xl text-xl font-semibold lg:leading-6 leading-7 text-gray-800 dark:text-white mt-2">{{ $det[0]->nombre_producto }}</h1>
      </div>
      <div class="py-4 border-b border-gray-200 flex items-center justify-between">
        <p class="text-base leading-4 text-gray-800 dark:text-gray-300">Número de Producto</p>
        <div class="flex items-center justify-center">
          <p class="text-sm leading-none text-gray-600 dark:text-gray-300 mr-3">{{ $det[0]->numero_producto }}</p>
      ...
      <div>
        <p class="xl:pr-48 text-base lg:leading-tight leading-normal text-gray-600 dark:text-gray-300 mt-7">{{ $det[0]->descripcion_producto }}</p>
        <p class="text-base leading-4 mt-7 text-gray-600 dark:text-gray-300">Categoría Producto: {{ $det[0]->categoria_producto }}</p>
        <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Rubro Producto: {{ $det[0]->rubro_producto }}</p>
        <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Unidad de Medida: {{ $det[0]->unidad_medida_producto }}</p>
        <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Precio: {{ $det[0]->precio_producto }}</p>
        <p class="text-base leading-4 mt-4 text-gray-600 dark:text-gray-300">Moneda: {{ $det[0]->moneda_producto }}</p>
