                ...
                <div class="w-full space-y-12 lg:w-1/2 ">
                    <div>
                        <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">
                            Explora Nuestras Opciones<br> Directorio Exportador
                        </h1>
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <button>
                                <a href="cli-show-empr">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Empresas
                                    </h1>
                                </a>
                            </button>
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <button>
                                <a href="#">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Categorías
                                    </h1>
                                </a>
                            </button>
                            <p class="mt-3 text-gray-500 dark:text-gray-300">
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <button>
                                <a href="cli-show-prod">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Productos
                                    </h1>
                                </a>
                            </button>
                            <p class="mt-3 text-gray-500 dark:text-gray-300">
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <button>
                                <a href="cli-reg-empr">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Registrar Empresa
                                </a>
                            </button>
                            </h1>
                            <p class="mt-3 text-gray-500 dark:text-gray-300">
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <button>
                                <a href="cli-reg-prod">
                                    <h1 class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Registrar Producto
                                </a>
                            </button>
                            </h1>
                            <p class="mt-3 text-gray-500 dark:text-gray-300">
